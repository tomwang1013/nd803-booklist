    ...
    public static ArrayList<Book> extractBooks(String jsonResponse) {
        ...
        try {
            ...
            for (int i = 0; i < books.length(); i++) {
                JSONObject properties = books.getJSONObject(i);
                bookList.add(new Book(properties.getString("title"),
                                      properties.getJSONArray("author").getString(0),
                                      properties.getString("image"),
                                      properties.getString("alt")));
            }
